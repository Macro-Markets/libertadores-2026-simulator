...
const STORAGE_KEY = "libertadores26-lang";
const BCP47 = { pt: "pt-BR", en: "en-US", es: "es-ES" };

const STRINGS = {
  pt: {
    "app.title": "Simulador Libertadores 2026 · macro.markets",
    "app.description": "Simule seus palpites da Libertadores 2026, da fase de grupos ao campeão, e compartilhe seu cenário.",
    "app.og.title": "Simulador Libertadores 2026 · macro.markets",
    ...
    "hero.title": "Simulador Libertadores",
    ...
    "qualifiers.title": "Classificados e formato",
    "qualifiers.seeds.kicker": "Primeiros e segundos",
    "qualifiers.seeds.title": "Classificados diretos",
    "qualifiers.seeds.second": "2º {team}",
    "qualifiers.format.kicker": "Formato",
    "qualifiers.format.title": "Dois clubes por grupo",
    "qualifiers.format.body": "Os dois primeiros de cada grupo avançam para as oitavas. Não há ranking de terceiros na Libertadores.",
    "qualifiers.knockout.kicker": "Chaveamento",
    "qualifiers.knockout.title": "Oitavas até a final",
    "qualifiers.knockout.body": "O bracket é preenchido automaticamente com 1º e 2º colocados de cada grupo.",
    ...
    "share.canvas.title": "Simulador Libertadores 2026",
    ...
    "share.filename": "simulador-libertadores-2026.png",
    "share.nativeTitle": "Simulador Libertadores 2026",
  ...
  en: {
    "app.title": "Libertadores 2026 Simulator · macro.markets",
    "app.description": "Simulate your 2026 Libertadores picks — from group games to champion — and share your scenario.",
    "app.og.title": "Libertadores 2026 Simulator · macro.markets",
    ...
    "hero.title": "Libertadores Simulator",
    ...
    "rounds.R4": "Matchday 4",
    "rounds.R5": "Matchday 5",
    "rounds.R6": "Matchday 6",
    ...
    "qualifiers.title": "Qualifiers and format",
    "qualifiers.seeds.kicker": "First and second place",
    "qualifiers.seeds.title": "Direct qualifiers",
    "qualifiers.seeds.second": "2nd {team}",
    "qualifiers.format.kicker": "Format",
    "qualifiers.format.title": "Two clubs per group",
    "qualifiers.format.body": "The top two clubs in each group advance to the round of 16. Libertadores has no third-place ranking.",
    "qualifiers.knockout.kicker": "Bracket",
    "qualifiers.knockout.title": "Round of 16 to final",
    "qualifiers.knockout.body": "The bracket is filled automatically from each group winner and runner-up.",
    ...
    "share.canvas.title": "Libertadores 2026 Simulator",
    ...
    "share.filename": "libertadores-2026-simulator.png",
    "share.nativeTitle": "Libertadores 2026 Simulator",
  ...
  es: {
    "app.title": "Simulador Libertadores 2026 · macro.markets",
    "app.description": "Simula tus predicciones del Libertadores 2026, desde la fase de grupos hasta el campeón, y comparte tu escenario.",
    "app.og.title": "Simulador Libertadores 2026 · macro.markets",
    ...
    "qualifiers.title": "Clasificados y formato",
    "qualifiers.seeds.kicker": "Primeros y segundos",
    "qualifiers.seeds.title": "Clasificados directos",
    "qualifiers.seeds.second": "2º {team}",
    "qualifiers.format.kicker": "Formato",
    "qualifiers.format.title": "Dos clubes por grupo",
    "qualifiers.format.body": "Los dos primeros de cada grupo avanzan a octavos. La Libertadores no tiene ranking de terceros.",
    "qualifiers.knockout.kicker": "Llaves",
    "qualifiers.knockout.title": "Octavos hasta la final",
    "qualifiers.knockout.body": "El cuadro se completa automáticamente con primeros y segundos de cada grupo.",
